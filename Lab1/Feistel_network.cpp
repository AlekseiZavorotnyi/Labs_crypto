...
public:
    ...
    void setupKeys(mass_b& en_de_crypt_key) {
        were_keysSetup = true;
        roundKeys_ = key_expansion->key_extension(en_de_crypt_key);
    }

    ~Feistel_network() = default;
};

class DES : public IEncryptionRound, public IKeyExpansion, public ISymmetricCipher{
public:

    DES() : feistel(this, this) {}
...
class DEAL : public IEncryptionRound, public IKeyExpansion{
public:
    DEAL() = default;

    DEAL(BitOrder order) : bit_order(order) {}
